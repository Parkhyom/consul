...
HAPROXY_DOMAIN=${HAPROXY_DOMIAN:-rongyi.com}
...
sed -e "s/HAPROXY_PROXY_PORT/${HAPROXY_PROXY_PORT}/g;s/HAPROXY_STATUS_PORT/${HAPROXY_STATUS_PORT}/g" /etc/consul-haproxy/haproxy.ctmpl.bak > /etc/consul-haproxy/haproxy.ctmpl
